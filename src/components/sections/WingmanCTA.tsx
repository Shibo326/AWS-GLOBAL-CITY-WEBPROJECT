  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            className="bg-card rounded-card border border-border p-4 max-w-[320px] w-full flex flex-col gap-3"
            aria-hidden="true"
          >
            {/* User message — right-aligned */}
            <div className="flex justify-end">
              <div className="bg-accent-blue/10 text-primary-text rounded-lg px-3 py-2 text-sm max-w-[85%]">
            ...
            <div className="flex justify-start">
              <div className="bg-card border border-border rounded-lg px-3 py-2 text-sm text-primary-text max-w-[85%]">
